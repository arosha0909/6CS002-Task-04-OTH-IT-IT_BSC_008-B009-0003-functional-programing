...
public class VollyBallClub implements Comparable<VollyBallClub> {
  ...
  public VollyBallClub(int position, String club, int played, int won, int drawn,
  ...
  public int compareTo(VollyBallClub c) {
